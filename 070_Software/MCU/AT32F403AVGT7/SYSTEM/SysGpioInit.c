...
const GPIO_CONFIG_DEF m_arrConfigBuf[] = {
	...
	{ TM_DIO_PORT,		TM_DIO_PINS,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},	
	{ TM_CLK_PORT,		TM_CLK_PINS,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
	{ TM_CS_PORT,		TM_CS_PINS,			GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
	...
	{ RS485_DIR_PORT	,		RS485_DIR_PINS,GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,LOW},
	...
	{ OUTPUT_PORT4,			OUTPUT_PINS4,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
	{ OUTPUT_PORT5,			OUTPUT_PINS5,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
	{ OUTPUT_PORT6,			OUTPUT_PINS6,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
	{ OUTPUT_PORT7,			OUTPUT_PINS7,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
	{ OUTPUT_PORT8,			OUTPUT_PINS8,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
	{ OUTPUT_PORT9,			OUTPUT_PINS9,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
	{ OUTPUT_PORT10,		OUTPUT_PINS10,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
	{ OUTPUT_PORT11,		OUTPUT_PINS11,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
	{ OUTPUT_PORT12,		OUTPUT_PINS12,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
	{ OUTPUT_PORT13,		OUTPUT_PINS13,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
	{ OUTPUT_PORT14,		OUTPUT_PINS14,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
	{ OUTPUT_PORT15,		OUTPUT_PINS15,		GPIO_MaxSpeed_50MHz,GPIO_Mode_OUT_PP,HIGH},
